    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        {loading ? (
          ...
          <div className="text-center">
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 text-left">
              <h2 className="text-xl font-bold mb-4">What is Fixr?</h2>
              <p className="text-gray-400 mb-4">
                Fixr is an autonomous builder agent that ships real projects across multiple chains:
              </p>
              ...
              <p className="text-gray-500 mt-4 text-sm">
                Semi-autonomous mode: plans are emailed for approval before execution.
              </p>
            </div>
          </div>
        )}
        ...
        <footer className="mt-16 text-center text-gray-600 text-sm">
          <p>Autonomous builder agent • Powered by Claude</p>
        </footer>
      </div>
    </main>
  );
